...
public class CConStartMenu_Patch
{
    ...
    private static void Awake_Postfix(CConStartMenu __instance)
    {
        ...
        // Create prefab menu
        MenuPrefab = Plugin.Instantiate(MainMenu, Plugin.I.transform);
        ...
        ButtonPrefab = Plugin.Instantiate(MenuPrefab.GetChild(0), Plugin.I.transform).gameObject.AddComponent<RandoButton>();
